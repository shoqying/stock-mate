    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="sidebar">
                ...
                <a href="editinfo1">내정보 조회/수정</a>
                <a href="changepassword1">비밀번호 변경</a>
                <a href="consultation">대시보드 사용법</a>
                <a href="signout" onclick="return confirmLogout();" style="color: red;">Sign out</a>
			<script>
